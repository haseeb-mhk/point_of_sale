      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
			 ...
			 Contact
				 <small style="font-size: 15px;font-weight: lighter">Manage Contact</small>
	...
	<div class="col-12">
		<div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title" align="left">All Contacts</h3>
				  <div align="right">
...
<!-- modal start -->
  ...
  <div class="modal-dialog">
	...
	<div class="col-12">
		<div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title" align="left">Add Customer</h3>
          ...
          <!-- /.card-header -->
              ...
              <div class="col-md-6">
                   <div class="form-group p-0">
                      <label>Contact Number</label>
                       <input type="number" class="form-control" placeholder="Enter Contact number" name="contact_number" required>
                      </div>
                ...
                <div class="form-group p-0">
                      <label>Alternative contact</label>
                       <input type="text" class="form-control" placeholder="Enter another contact" name="another_contact" required>
                      </div>
            ...
            <div class="row">
              <div class="col-md-6">
                 <div class="form-group p-0">
                      <label>Email</label>
                       <input type="email" class="form-control" placeholder="Enter customer email" name="email" required>
                      </div>
                 ...
                 <div class="form-group p-0">
                      <label>Address</label>
                       <input type="text" class="form-control" placeholder="Enter customer address" name="address" required>
                      </div>
            ...
            <div class="col-md-6">
                 <div class="form-group p-0">
                      <label>Opening Blanace</label>
                       <input type="number" class="form-control" placeholder="Enter due Balance" name="balance" required>
                      </div>
